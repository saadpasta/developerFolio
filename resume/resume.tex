...
\item \textbf{Proficient:} Python, Java, JavaScript, React, Jest, Flask, MATLAB\\
\item \textbf{Familiar:} Go, MobX, Typescript, Google Cloud Platform, JUnit, pytest, Docker, SQL, PHP\\
\end{itemize}
...
% INTRODUCTION TO THE TOOL I WORKED ON:
