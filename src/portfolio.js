...
const skillsSection = {
  title: "What I do",
  subTitle:
    "GAME DEVELOPMENT PROFESSIONAL WHO WANTS TO EXPLORE EVERYTHING IN GAMES",
  skills: [
    emoji("⚡ Programming Languages: C#, C++, Python, Java"),
    emoji(
      "⚡ Software Design: SOLID, Clean Code, MVC, ECS, DI, Observer, Service Locator, Black Board, Factory, Singleton"
    ),
    emoji("⚡ Game Engines: Unity, Unreal Engine 5"),
    emoji(
      "⚡ Graphics: Adobe Photoshop, Adobe After Effects, Blender, Aseprite, Krita"
    ),
...
const contactInfo = {
  ...
  subtitle2: "Experienced Game Programmer & Software Engineer",
  subtitle3: "Mahsa Eskandari",
