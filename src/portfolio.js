...
const socialMediaLinks = {
  github: "https://github.com/Alilock",
  linkedin: "https://www.linkedin.com/in/ali-nasrullayev-b9a05b250/",
  gmail: "alilock@gmail.com",
  facebook: "https://www.facebook.com/ali.nesrullayev.5",
...
const educationInfo = {
  ...
  schools: [
    {
      schoolName: "Unec",
      logo: require("./assets/images/UNEC_1.png"),
      subHeader: "Finance",
  ...
  experience: [
    {
      ...
      company: "NeveraTech",
      companylogo: require("./assets/images/neveratech.jpg"), // You may need to update the logo path.
      date: "February 2023 – Present", // Please specify the start date.
      desc: "Developing mobile applications using React Native and handling backend processes with Node.js.",
      descBullets: [
    ...
    },
    {
      ...
      companylogo: require("./assets/images/codeacademy.jpeg"), // You may need to update the logo path.
      date: "May 2023 – Present", // Please specify the start date.
      desc: "Teaching mobile development courses focused on React Native technology."
    },
  ]
};
  ...
  projects: [
    {
      ...
      footerLink: [
        {
          name: "Visit Website",
          url: "https://defendovb.az/"
        }
        //  you can add extra buttons here.
      ]
    },
    {
      image: require("./assets/images/alishanjpg.jpg"),
      projectName: "AlishanCompany",
      projectDesc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit",
      footerLink: [
        {
          name: "Visit Website",
          url: "https://alishancompany.az/"
        }
      ]
    }
  ],
...
const contactInfo = {
  ...
  number: "+994 703553193",
  email_address: "alichn@code.edu.az"
};

// Twitter Section

const twitterDetails = {
  userName: "alinasrullayev1", //Replace "twitter" with your twitter username without @
  display: true // Set true to display this section, defaults to false
};
