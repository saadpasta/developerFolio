...
const greeting = {
  ...
  title: "Hi, I'm Simba",
  subTitle: emoji("Experienced 1st and 2nd Line Support and FullsStack Web Developer proficient in Linux, macOS, Windows, Windows Server, NodeJs, MongoDB, SQL, Express.js, HTML5, CSS3, Flutter, Javascript with further interest in Progressive Web Apps."),
