...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Software Engineering student 🚀 curently learning in fields such as .NET frameworks / MVC Distrubuted Systems / REACT js / Android Development / Cyber Security."
  ),
  //resumeLink:
...
const skillsSection = {
  title: "What I do",
  subTitle: "Life long learner, exploring the software development world",
  skills: [
    emoji(
      "⚡ Developing simple projects with API integration and practical use."
    ),
