...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/12Roi4IBa-H6ZLeRSWn0DWo5OwMNn971L/view?usp=sharing", // Set to empty to hide the button
  ...
  experience: [
    {
      ...
      companylogo: require("./assets/images/lq_logo.jpg"),
      date: "June 2019 – Present",
      desc: `FullStack developer with 2.9+ Years of hands-on experience in developing
      Web applications in JavaScript, NodeJs, Python, React, AWS, and Serverless
      frameworks.`,
      descBullets: [
        `Developed full-stack applications using latest industry-adopted technologies
        and frameworks.`,
