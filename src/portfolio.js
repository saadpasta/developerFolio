...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1haHpb854ushSlx7Y9uTMY1owAOsyVxr1/view?usp=sharing", // Set to empty to hide the button
  ...
  schools: [
    {
      ...
      logo: require("./assets/images/maküLogo.jpg"),
      subHeader: "Master of Science in Computer Programming",
  ...
  experience: [
    {
      ...
      company: "Softalya",
      companylogo: require("./assets/images/softalyaLogo.png"),
  ...
  projects: [
    {
      ...
      projectName: "HappyKitchen",
      projectDesc: "It was an intern project. Not published Yet.",
    },
  ],
  display: true // Set false to hide this section, defaults to true
};
