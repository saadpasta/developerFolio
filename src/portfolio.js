...
const projectPages = [
  {
    ...
    text: [
      {
        text: "RayVis is a tool for visualizing large rays data sets in a 3D scene. "
      ...
      {
        text: "RayVis uses its own data format for saving and loading. "
      ...
      {
        text: "The Ray Mesh visualization is a naive approach for the visualizations of many rays. "
      ...
      {
        text: "The vector field visualizes the volume data through arrows drawn in the scene. "
      ...
      {
        text: "The density volume visualizes the ray count of the volume data structure with raymarching. "
  ...
  },
  {
    ...
    text: [
      {
        text: "The fractal engine is a hardware-oriented, specialised Framework for the Nintendo Switch ™ console and was created for the GameLab III course of the games engineering bachelor in Würzburg. "
      ...
      {
        text: "Blender and GIMP were used to model and animate the promotional material and the sprites used in the minesweeper implementation. "
...
const gameJams = {
  ...
  projects: [
    ...
    },
    {
      ...
      projectName: "RayVis",
      projectDesc:
        "Raytracing Visualization Prototype.",
      footerLink: [
        {
          name: "Project Page",
          url: "./rayvis"
