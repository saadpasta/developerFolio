...
const skillsSection = {
  title: "Mục đích và kĩ năng của mình?",
  subTitle: "Có một niềm đam mê, thích tư duy và đôi khi tự làm lú bản thân 🐧",
  skills: [
    emoji(
      "⚡ Có kĩ năng về mảng front-end và backend, biết tốt về python và chuyên về swift (code app cho các hệ sinh thái của Apple.Inc) "
    ),
    emoji("⚡ Chuyên về an ninh mạng, an toàn mạng"),
    emoji(
      " Tôi không biết tại sao nhưng tôi lại biết về mảng edit (của nhà Adobe) và sáng tác nhạc (Fl studio)"
    )
  ],
...
const educationInfo = {
  ...
  schools: [
    {
      schoolName: "Trung Học Phổ Thông Chợ Mới",
