...
const bigProjects = {
  ...
  projects: [
    {
      image: require("./assets/images/life-dashboard.png"),
      projectName: "Life Dashboard",
      projectDesc:
        "A full-stack web application designed to provide a comprehensive view of your health and wellness metrics in real-time",
      footerLink: [
        {
          name: "Visit Website",
