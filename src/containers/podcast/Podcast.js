      ...
      <div className='main'>
        <div className='podcast-header'>
          ...
          <div className='podcast-main-div' id='podcast'>
            {Array.isArray(podcastSection.podcast) ? podcastSection.podcast.map((podcastLink, indx) => {
              return (
                <div key={indx}>
                  <iframe
                    title='podcast'
            ...
            }) : console.log('podcast is not an array in podcastSection inside portfolio')}
          </div>
      </div>
    </Fade>
  )
