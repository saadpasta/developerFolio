...
## 🎥 See Folify in action

<!-- TODO: replace with your Folify demo video (YouTube / Loom link) or an embedded GIF -->
> **Watch the 2-minute demo:** [ your video link here ]

<!-- Example embed once you have a video:
[![Watch the Folify demo](https://img.youtube.com/vi/VIDEO_ID/maxresdefault.jpg)](https://youtu.be/VIDEO_ID)
-->
...
| Cost | Free (self-hosted) | Free plan · Pro $5/mo (14-day free trial) |
...
- **Custom domain (Pro)** — point `yourname.com` at your portfolio with automatic HTTPS.
